...
public final class QueryUtils {
    ...
    public static ArrayList<earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject basejsone = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray earthquakearray = basejsone.getJSONArray("features");
            for (int i =0 ; i < earthquakearray.length() ; i++){

                JSONObject currentearthquke = earthquakearray.getJSONObject(i);
                JSONObject proparties =currentearthquke.getJSONObject("properties");

                double magnitude = proparties.getDouble("mag");

                String location = proparties.getString("place");

                int time = proparties.getInt("time");
                ...
                String url = proparties.getString("url");
